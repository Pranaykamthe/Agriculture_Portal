...
<?php require ('fheader.php');  ?>
 ...
 <script>
  window.addEventListener("load", function() {
    const endpoint = "https://newsapi.org/v2/everything?q=Agriculture&sortBy=popularity&apiKey=example";
    fetch(endpoint)
    .then(response => {
      if (!response.ok) {
...
<div class="container-fluid ">
	...
	error_reporting(E_ERROR | E_PARSE);
	       ...
	       // https://newsapi.org/v2/everything?q=Agriculture&sortBy=popularity&apiKey=YOUR_API_KEY
	
        $url="https://newsapi.org/v2/everything?q=Agriculture&sortBy=popularity&apiKey=example";   //Your API KEY
