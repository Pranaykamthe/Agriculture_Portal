      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
		  ...
		  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
			<a class="dropdown-item" href="http://localhost/agriculture-portal/farmer/fregister.php">Farmer</a>
			<a class="dropdown-item" href="http://localhost/agriculture-portal/customer/cregister.php">Customer</a>
		  </div>
		</div>
			</li>
