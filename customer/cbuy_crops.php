			...
			<?php
							...
							require_once "StripePayment/config.php";
								...
								$session = \Stripe\Checkout\Session::create([
									...
									'mode' => 'payment',
									'success_url' => 'http://localhost/agriculture-portal/customer/cupdatedb.php',
									'cancel_url' => 'http://localhost/agriculture-portal/customer/cbuy_crops.php',
								]);
